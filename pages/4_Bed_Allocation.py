...
# Custom Styling & Dark Navy Blue Sidebar
st.markdown("""
<style>
...
# Render Wards & Beds Cards (Cleaned HTML String - Single Block)
for ward_name, beds in st.session_state.beds_master.items():
    ...
    for idx, bed in enumerate(beds):
        with cols[idx]:
            ...
            # संपूर्ण HTML कार्ड एकाच स्ट्रिंग मध्ये कम्बाइन केले आहे ज्याने blank boxes हटले आहेत
            st.markdown(f"""
            <div class="bed-box">
